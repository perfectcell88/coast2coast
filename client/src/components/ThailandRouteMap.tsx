...
// All route curves have been straightened (smaller quadratic offsets) for a more direct look
const ROUTES_DATA: RouteData[] = [
  ...
  },
  {
    ...
    // Clean direct line down the coast to Singapore
    gulfSea: "M 216.5,84.1 Q 260,280 232.0,475.0",
    landBridge: "M 232.0,475.0 L 232.0,475.0", 
    // Sweeping west around the southern tip directly to Phuket
    andamanSea: "M 232.0,475.0 Q 140,480 57.1,353.0",
    originPin: "pattaya",
    destPin: "phuket",
    viaPin: "singapore",
    direction: "forward",
  ...
  return (
    <div ref={ref} className="relative w-full select-none" style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          >
            ...
            {visiblePins.map((pinId, i) => {
              ...
              return (
                ...
                >
                  <circle cx={pin.x} cy={pin.y} r={outerR + 4} fill={color} opacity="0.1" />
      ...
      <div className="flex items-center justify-center gap-6 mt-4">
        {[
          { color: "#00c8c8", dash: "3 6", label: "Sea route" },
          { color: "#f59e0b", dash: "5 4", label: "Overland" },
        ].map((l) => (
          <div key={l.label} className="flex items-center gap-2">
            <svg width="24" height="4" viewBox="0 0 24 4">
              <line x1="0" y1="2" x2="24" y2="2" stroke={l.color} strokeWidth="3" strokeDasharray={l.dash} strokeLinecap="round" />
            </svg>
