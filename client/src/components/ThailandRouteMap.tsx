/**
 * ThailandRouteMap — Enhanced Premium Version (Singapore Update)
...
const ROUTES_DATA: RouteData[] = [
  {
    ...
    gulfSea: "M 216.5,84.1 Q 190,140 107.5,213.7",
    landBridge: LAND_BRIDGE,
    andamanSea: "M 71.0,242.5 Q 60,280 57.1,353.0",
    originPin: "pattaya",
    destPin: "phuket",
    direction: "forward",
  },
  {
    ...
    gulfSea: "M 107.5,213.7 Q 190,140 216.5,84.1",
    landBridge: "M 71.0,242.5 L 107.5,213.7",
    andamanSea: "M 57.1,353.0 Q 60,280 71.0,242.5",
    originPin: "phuket",
    destPin: "pattaya",
    direction: "reverse",
  },
  ...
  },
  {
    ...
    // Premium direct line to Singapore
    gulfSea: "M 216.5,84.1 L 232.0,475.0", 
    landBridge: "M 232.0,475.0 L 232.0,475.0", 
    // Premium direct line from Singapore to Phuket
  ...
  return (
    <div ref={ref} className="relative w-full select-none" style={{ maxWidth: 520, margin: "0 auto" }}>
      ...
      {onPrev && (
        <button
          ...
          style={{
            ...
            backdropFilter: "blur(6px)", color: "#00c8c8"
          }}
        >
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-1.5 z-20">
          {Array.from({ length: totalRoutes }).map((_, i) => (
            <div
              key={i}
              style={{
                width: i === activeRoute ? "18px" : "6px", height: "6px",
                borderRadius: "3px", background: i === activeRoute ? "#00c8c8" : "rgba(0,200,200,0.3)",
        ...
        >
          ...
          >
            ...
            {shouldAnimate && (
              <>
                <motion.path
                  ...
                  strokeWidth="2.5"
                  strokeLinecap="round"
                  strokeDasharray={route.isDotted ? "2 8" : "none"}
            ...
            {visiblePins.map((pinId, i) => {
              ...
              const color = isHighlighted ? "#00c8c8" : "#94a3b8";
              ...
              return (
                <motion.g
                  ...
                  initial="hidden"
                  animate="visible"
                  variants={popIn(0.3 + i * 0.15)}
                >
                  <circle cx={pin.x} cy={pin.y} r={isHighlighted ? 6 : 4} fill={color} filter="url(#glow-pin)" />
                  <text
      ...
      <div className="flex items-center justify-center gap-6 mt-4">
        {[
          { color: "#00c8c8", dash: "none", label: "Sea route" },
          { color: "#00c8c8", dash: "2 5", label: "Singapore connection" },
        ].map((l) => (
          <div key={l.label} className="flex items-center gap-2">
            <svg width="24" height="4"><line x1="0" y1="2" x2="24" y2="2" stroke={l.color} strokeWidth="3" strokeDasharray={l.dash} /></svg>
            <span className="text-[10px] uppercase tracking-wider text-white/50 font-bold">{l.label}</span>
          </div>
        ))}
      </div>
    </div>
